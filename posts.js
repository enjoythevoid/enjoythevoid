/* ===========================================================
   ...
   videoCovers opcional. lista de imagens pra usar como thumb de cada
             vídeo (na mesma ordem de "videos") em vez do frame
             automático do YouTube/Vimeo — "" pra manter o automático
             num vídeo específico. o admin.html escreve isso sozinho
             quando você escolhe uma foto pelo ícone 🖼 no vídeo.
